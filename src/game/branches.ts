...
const GRADE_MONO: Record<"respect" | "watch" | "liability", Record<MentorId, string>> = {
  respect: {
    lin_ruoning: "这条线的推导链我反复看过了。下次遇到这种判断，我放心交给你。",
  ...
  contribute: {
    nodes: [
      monoNode(
        ...
        "zhao_chengyu",
        "认真",
        "你还记得年初帮我顺因子那次吗？上个月投委会临时缺人，我主动跟带头的说，顾行之我熟，研究扛得住，数据也看得懂，让他顶上。以后投委会这种门，我给你留着。你帮我顺的那口气，我还。",
      ),
    ],
  },
};
      ...
      nodes: [
        {
          ...
          role: "投研部前辈",
          mood: "认真",
          text: "林若宁把一份还冒热气的早餐推到你手边：这周你已经第三次半夜发研报了。我担心你先把身体熬垮。先吃点东西。这版框架确实比上个月利落。",
          prompt: "点击继续。",
          pose: "soft",
          bg: "research-room",
          bgm: "morning-loop",
      ...
      nodes: [
        {
          ...
          role: "宏观策略师",
          mood: "警觉",
          text: "周明昭盯着你看了两秒：你脸色比上周的回撤还难看。研究要做很多年，今晚先停。我见过太多聪明人因为长期透支，最后连判断都做不稳。",
          prompt: "点击继续。",
          pose: "serious",
          bg: "research-room",
          bgm: "morning-loop",
    ...
    contribute: {
      ...
      decisions: [
        d({
          ...
          label: "赴约闭门路演，混个「自己人」",
          category: "roadshow",
          description: "参加圈内人的小范围交流。信息密度高，人情也重。",
          to: "chen_xinghe",
          val: 5,
