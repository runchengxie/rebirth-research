  ...
  const allMonths: ResearchDecision[][] = [
    ...
    [
      {
        ...
        effects: { researchCredibility: 15, committeeAdoption: 7, portfolioNav: 0.02, viewAccuracy: 9, clientFeedback: 4, teamTrust: 5, fatigue: 11, lifeBalance: -7, characterRelations: [{ characterId: "lin_ruoning", value: 8 }] },
        evidenceLevel: 18, clarityLevel: 18, riskAwareness: 10, reflectionValue: 6,
        backgroundNote: "产业链拆解是区分热点和主线的最有效工具。",
      },
      {
        id: "feb-factor",
      ...
      },
      {
        ...
        effects: { researchCredibility: 5, committeeAdoption: 9, portfolioNav: 0.005, viewAccuracy: 5, clientFeedback: 12, teamTrust: 6, fatigue: 5, lifeBalance: -3, characterRelations: [{ characterId: "lin_ruoning", value: 5 }] },
        evidenceLevel: 8, clarityLevel: 12, riskAwareness: 8, reflectionValue: 3,
        backgroundNote: "好的研究故事能把产业链逻辑转成客户听得懂的语言。",
      },
      {
        id: "feb-risk",
        ...
        effects: { researchCredibility: 8, committeeAdoption: 4, portfolioNav: 0, viewAccuracy: 6, clientFeedback: 5, teamTrust: 7, fatigue: 4, lifeBalance: -1, characterRelations: [{ characterId: "zhou_mingzhao", value: 7 }] },
        evidenceLevel: 12, clarityLevel: 14, riskAwareness: 18, reflectionValue: 6,
        backgroundNote: "在所有人都在追AI的时候提醒估值风险，需要勇气也需要证据。",
      },
      {
        id: "feb-help",
        label: "帮陈星禾对因子回测结果",
        ...
        effects: { researchCredibility: 3, committeeAdoption: 2, portfolioNav: 0.005, viewAccuracy: 4, clientFeedback: 2, teamTrust: 9, fatigue: 4, lifeBalance: -1, characterRelations: [{ characterId: "chen_xinghe", value: 8 }] },
        evidenceLevel: 8, clarityLevel: 8, riskAwareness: 10, reflectionValue: 4,
        backgroundNote: "帮同事复核数据既是协作也是学习，你帮陈星禾排掉了一个样本偏差。",
      },
      {
        id: "feb-life",
        ...
        effects: { researchCredibility: 0, committeeAdoption: 0, portfolioNav: 0, viewAccuracy: 2, clientFeedback: 0, teamTrust: 2, fatigue: -12, lifeBalance: 10, characterRelations: [{ characterId: "chen_xinghe", value: 3 }] },
        evidenceLevel: 2, clarityLevel: 4, riskAwareness: 8, reflectionValue: 10,
        backgroundNote: "行情亢奋的时候保持体能，比多熬一个小时更有长期价值。",
      },
    ],
    // ══ 三月：政策窗口与设备更新链 ══
    [
      ...
      },
      {
        ...
        effects: { researchCredibility: 6, committeeAdoption: 7, portfolioNav: 0.005, viewAccuracy: 9, clientFeedback: 7, teamTrust: 8, fatigue: 4, lifeBalance: -2, characterRelations: [{ characterId: "zhou_mingzhao", value: 5 }] },
        evidenceLevel: 12, clarityLevel: 10, riskAwareness: 10, reflectionValue: 4,
        backgroundNote: "和下游聊一圈后发现，文件到订单的传导比市场预期的慢一两个季度。",
      },
      {
        id: "mar-orderflow",
      ...
      },
      {
        ...
        evidenceLevel: 2, clarityLevel: 2, riskAwareness: 6, reflectionValue: 10,
        backgroundNote: "错过了政策解读的第一波讨论，但带着更清晰的头脑回到了周一晨会。",
      },
    ],
    // ══ 四月：一季报验证与国九条 ══
    [
      {
        ...
        effects: { researchCredibility: 16, committeeAdoption: 8, portfolioNav: 0.02, viewAccuracy: 12, clientFeedback: 4, teamTrust: 6, fatigue: 10, lifeBalance: -5, characterRelations: [{ characterId: "lin_ruoning", value: 10 }] },
        evidenceLevel: 18, clarityLevel: 18, riskAwareness: 12, reflectionValue: 8,
        backgroundNote: "交叉验证是区分真实业绩和会计调节的最有效方法。",
      },
      {
        id: "apr-dividend",
      ...
      },
      {
        ...
        effects: { researchCredibility: 6, committeeAdoption: 10, portfolioNav: 0.005, viewAccuracy: 6, clientFeedback: 6, teamTrust: 8, fatigue: 4, lifeBalance: -2, characterRelations: [{ characterId: "zhou_mingzhao", value: 5 }] },
        evidenceLevel: 8, clarityLevel: 14, riskAwareness: 8, reflectionValue: 6,
        backgroundNote: "清晰的汇报让团队对你的研究框架有了更强的信任。",
      },
      {
        id: "apr-skip",
        label: "扫一眼净利润增速就下判断",
      ...
      },
      {
        ...
        effects: { researchCredibility: 4, committeeAdoption: 3, portfolioNav: 0, viewAccuracy: 5, clientFeedback: 2, teamTrust: 10, fatigue: 5, lifeBalance: -1, characterRelations: [{ characterId: "zhou_mingzhao", value: 9 }] },
        evidenceLevel: 10, clarityLevel: 10, riskAwareness: 8, reflectionValue: 4,
        backgroundNote: "帮周明昭跑回归的同时，你也在建立宏观和行业的映射框架。",
      },
      {
        id: "apr-life",
        ...
        effects: { researchCredibility: 0, committeeAdoption: -2, portfolioNav: 0, viewAccuracy: 0, clientFeedback: -1, teamTrust: -1, fatigue: -14, lifeBalance: 14, characterRelations: [{ characterId: "chen_xinghe", value: 4 }] },
        evidenceLevel: 2, clarityLevel: 4, riskAwareness: 6, reflectionValue: 12,
        backgroundNote: "在所有人都在加班看财报的时候离开两天，需要勇气，也需要对自己的节奏有信心。",
      },
    ],
    // ══ 五月：地产政策与风格再平衡 ══
    [
      {
        ...
        effects: { researchCredibility: 12, committeeAdoption: 8, portfolioNav: 0.015, viewAccuracy: 8, clientFeedback: 5, teamTrust: 5, fatigue: 9, lifeBalance: -5, characterRelations: [{ characterId: "zhou_mingzhao", value: 8 }] },
        evidenceLevel: 16, clarityLevel: 16, riskAwareness: 14, reflectionValue: 6,
        backgroundNote: "风格剪刀差已经到了历史极端，均值回归的概率在积累，但触发时点不确定。",
      },
      {
        id: "may-crowding",
        ...
        effects: { researchCredibility: 10, committeeAdoption: 6, portfolioNav: 0.01, viewAccuracy: 9, clientFeedback: 4, teamTrust: 4, fatigue: 7, lifeBalance: -3, characterRelations: [{ characterId: "chen_xinghe", value: 10 }] },
        evidenceLevel: 16, clarityLevel: 12, riskAwareness: 18, reflectionValue: 6,
        backgroundNote: "因子拥挤度显示红利因子已经处在历史最高拥挤区间，反转风险在累积。",
      },
      {
        id: "may-debate",
      ...
      },
      {
        ...
        effects: { researchCredibility: -6, committeeAdoption: 2, portfolioNav: 0.005, viewAccuracy: -12, clientFeedback: 1, teamTrust: -4, fatigue: 6, lifeBalance: -3, characterRelations: [{ characterId: "zhou_mingzhao", value: -6 }] },
        evidenceLevel: 2, clarityLevel: 2, riskAwareness: 2, reflectionValue: 2,
        backgroundNote: "追最强势风格是散户的反射，不是研究员的判断。",
      },
      {
        id: "may-field",
        ...
        effects: { researchCredibility: 8, committeeAdoption: 6, portfolioNav: 0.005, viewAccuracy: 10, clientFeedback: 7, teamTrust: 5, fatigue: 6, lifeBalance: -3, characterRelations: [{ characterId: "lin_ruoning", value: 7 }] },
        evidenceLevel: 14, clarityLevel: 12, riskAwareness: 10, reflectionValue: 4,
        backgroundNote: "一线调研显示政策传导比市场预期的慢一两个季度，但方向在改善。",
      },
      {
        id: "may-life",
        ...
        effects: { researchCredibility: 2, committeeAdoption: 0, portfolioNav: 0, viewAccuracy: 2, clientFeedback: 0, teamTrust: 0, fatigue: -8, lifeBalance: 10, characterRelations: [{ characterId: "chen_xinghe", value: 4 }] },
        evidenceLevel: 2, clarityLevel: 4, riskAwareness: 6, reflectionValue: 12,
        backgroundNote: "风格切换时最危险的是瞎动。有时候最好的交易是不交易，最好的研究是投资自己。",
      },
    ],
    // ══ 六月-十二月见下方（模板模式相同） ══
    // 六月：中报预期与半导体周期
    [
      {
        ...
        effects: { researchCredibility: 14, committeeAdoption: 8, portfolioNav: 0.02, viewAccuracy: 9, clientFeedback: 5, teamTrust: 6, fatigue: 10, lifeBalance: -6, characterRelations: [{ characterId: "lin_ruoning", value: 8 }] },
        evidenceLevel: 18, clarityLevel: 18, riskAwareness: 12, reflectionValue: 6,
        backgroundNote: "半导体周期的拐点要三个指标同时确认，单看任何一个都可能出错。",
      },
      {
        id: "jun-flow",
      ...
      },
      {
        ...
        effects: { researchCredibility: 5, committeeAdoption: 7, portfolioNav: 0.005, viewAccuracy: 5, clientFeedback: 12, teamTrust: 6, fatigue: 5, lifeBalance: -3, characterRelations: [{ characterId: "zhou_mingzhao", value: 5 }] },
        evidenceLevel: 6, clarityLevel: 12, riskAwareness: 8, reflectionValue: 4,
        backgroundNote: "客户对你的框架表示认可，但也追问了两个你的假设还没覆盖的风险点。",
      },
      {
    ...
    [
      {
        ...
        effects: { researchCredibility: 14, committeeAdoption: 7, portfolioNav: 0.02, viewAccuracy: 8, clientFeedback: 4, teamTrust: 6, fatigue: 10, lifeBalance: -5, characterRelations: [{ characterId: "lin_ruoning", value: 8 }] },
        evidenceLevel: 18, clarityLevel: 18, riskAwareness: 10, reflectionValue: 6,
        backgroundNote: "产业链拆解发现激光雷达环节的技术壁垒最高，但估值也已经最贵。",
      },
      {
        id: "jul-signal",
        ...
        effects: { researchCredibility: 10, committeeAdoption: 5, portfolioNav: 0.015, viewAccuracy: 10, clientFeedback: 3, teamTrust: 5, fatigue: 7, lifeBalance: -3, characterRelations: [{ characterId: "chen_xinghe", value: 10 }] },
        evidenceLevel: 16, clarityLevel: 12, riskAwareness: 14, reflectionValue: 4,
        backgroundNote: "陈星禾的量价过滤模型帮你排掉了至少三四个蹭概念的伪扩散标的。",
      },
      {
        id: "jul-share",
        ...
        effects: { researchCredibility: 6, committeeAdoption: 6, portfolioNav: 0.005, viewAccuracy: 6, clientFeedback: 4, teamTrust: 12, fatigue: 4, lifeBalance: -1, characterRelations: [{ characterId: "chen_xinghe", value: 7 }, { characterId: "lin_ruoning", value: 5 }] },
        evidenceLevel: 8, clarityLevel: 10, riskAwareness: 10, reflectionValue: 6,
        backgroundNote: "三个人的覆盖范围交叉后，发现了两个被市场忽视的子环节。",
      },
      {
        id: "jul-chase",
        label: "追着涨幅最大的支线跑",
        ...
        effects: { researchCredibility: -6, committeeAdoption: 2, portfolioNav: 0.005, viewAccuracy: -8, clientFeedback: 2, teamTrust: -3, fatigue: 8, lifeBalance: -4, characterRelations: [{ characterId: "zhou_mingzhao", value: -5 }] },
        evidenceLevel: 2, clarityLevel: 2, riskAwareness: 2, reflectionValue: 2,
        backgroundNote: "追涨是交易员的工作，研究员的任务是找到涨的理由，或者找到不应该涨的理由。",
      },
      {
        id: "jul-field",
      ...
      },
      {
        ...
        effects: { researchCredibility: -1, committeeAdoption: -3, portfolioNav: 0, viewAccuracy: 2, clientFeedback: 0, teamTrust: -2, fatigue: -16, lifeBalance: 16, characterRelations: [{ characterId: "chen_xinghe", value: 4 }] },
        evidenceLevel: 2, clarityLevel: 4, riskAwareness: 8, reflectionValue: 14,
        backgroundNote: "在所有人都在追扩散的时候度假，需要勇气。回来时你发现真正的主线比离开前更清晰了。",
      },
    ],
    // 八月-十二月使用相似的5-6选模板
    // 八月：中报落地与市场筑底
    [
      ...
      },
      {
        ...
        effects: { researchCredibility: -10, committeeAdoption: -6, portfolioNav: -0.005, viewAccuracy: -5, clientFeedback: -6, teamTrust: -10, fatigue: 1, lifeBalance: 0, characterRelations: [{ characterId: "lin_ruoning", value: -8 }] },
        evidenceLevel: 2, clarityLevel: 2, riskAwareness: 2, reflectionValue: 0,
        backgroundNote: "甩锅是职业生涯最快的退步方式。市场永远是对的，但研究框架可以越来越好。",
      },
      {
        id: "aug-help",
    ...
    [
      ...
      },
      {
        ...
        effects: { researchCredibility: -8, committeeAdoption: 3, portfolioNav: 0.015, viewAccuracy: -10, clientFeedback: -3, teamTrust: -5, fatigue: 8, lifeBalance: -6, characterRelations: [{ characterId: "zhou_mingzhao", value: -8 }] },
        evidenceLevel: 2, clarityLevel: 2, riskAwareness: 0, reflectionValue: 0,
        backgroundNote: "在史诗级反弹中踏空确实痛苦，但满仓追涨之后的回撤会让你怀疑自己的职业判断。",
      },
      {
        id: "sep-defense",
        ...
        effects: { researchCredibility: 10, committeeAdoption: 14, portfolioNav: 0.01, viewAccuracy: 7, clientFeedback: 6, teamTrust: 8, fatigue: 8, lifeBalance: -5, characterRelations: [{ characterId: "zhou_mingzhao", value: 10 }] },
        evidenceLevel: 12, clarityLevel: 16, riskAwareness: 16, reflectionValue: 8,
        backgroundNote: "在所有人都在喊牛市的时候，敢于在投委会给出风险边界的人，才是真正的风控意识。",
      },
      {
        id: "sep-life",
        ...
        effects: { researchCredibility: 0, committeeAdoption: -2, portfolioNav: 0, viewAccuracy: 3, clientFeedback: -1, teamTrust: 1, fatigue: -12, lifeBalance: 10, characterRelations: [{ characterId: "lin_ruoning", value: 4 }] },
        evidenceLevel: 2, clarityLevel: 4, riskAwareness: 12, reflectionValue: 10,
        backgroundNote: "在暴涨中保持作息，说明你对市场波动有了抗体。这是研究员最稀缺的心理素质。",
      },
    ],
    // 十月：年末排名与情绪过热
    [
      ...
      },
      {
        ...
        effects: { researchCredibility: 5, committeeAdoption: 10, portfolioNav: 0.005, viewAccuracy: 6, clientFeedback: 10, teamTrust: 7, fatigue: 4, lifeBalance: -2, characterRelations: [{ characterId: "lin_ruoning", value: 6 }] },
        evidenceLevel: 6, clarityLevel: 10, riskAwareness: 10, reflectionValue: 4,
        backgroundNote: "了解基金经理的真实想法后，你对年末排名行情的判断有了更准确的锚。",
      },
      {
        id: "oct-gamble",
        ...
        effects: { researchCredibility: -10, committeeAdoption: 2, portfolioNav: 0.005, viewAccuracy: -12, clientFeedback: -3, teamTrust: -5, fatigue: 8, lifeBalance: -5, characterRelations: [{ characterId: "zhou_mingzhao", value: -7 }] },
        evidenceLevel: 2, clarityLevel: 2, riskAwareness: 0, reflectionValue: 2,
        backgroundNote: "为了排名放弃框架的研究员，排名结束后会发现自己一无所有。",
      },
      {
        id: "oct-help",
        ...
        effects: { researchCredibility: 5, committeeAdoption: 4, portfolioNav: 0.005, viewAccuracy: 6, clientFeedback: 2, teamTrust: 10, fatigue: 5, lifeBalance: -1, characterRelations: [{ characterId: "chen_xinghe", value: 10 }] },
        evidenceLevel: 10, clarityLevel: 10, riskAwareness: 10, reflectionValue: 6,
        backgroundNote: "量化和基本面的交叉验证，是你和陈星禾之间最有默契的工作方式。",
      },
      {
        id: "oct-life",
        ...
        effects: { researchCredibility: 2, committeeAdoption: -1, portfolioNav: 0, viewAccuracy: 4, clientFeedback: 1, teamTrust: 3, fatigue: -8, lifeBalance: 10, characterRelations: [{ characterId: "lin_ruoning", value: 5 }] },
        evidenceLevel: 2, clarityLevel: 4, riskAwareness: 10, reflectionValue: 12,
        backgroundNote: "不被排名焦虑裹挟的人，才能做出对明年更有价值的研究。",
      },
    ],
    // 十一月：估值切换与海外冲击
    [
      ...
      },
      {
        ...
        effects: { researchCredibility: 3, committeeAdoption: 1, portfolioNav: 0, viewAccuracy: 5, clientFeedback: 3, teamTrust: 2, fatigue: -6, lifeBalance: 10, characterRelations: [{ characterId: "lin_ruoning", value: 5 }] },
        evidenceLevel: 4, clarityLevel: 8, riskAwareness: 8, reflectionValue: 14,
        backgroundNote: "整理工作日志的时候你会发现：今年的很多判断偏差，其实在半年前的某次选择里就已经有了苗头。",
      },
    ],
    // 十二月：年度收官与跨年配置
    [
      ...
      },
      {
        ...
        effects: { researchCredibility: 4, committeeAdoption: 4, portfolioNav: 0.005, viewAccuracy: 5, clientFeedback: 3, teamTrust: 16, fatigue: 5, lifeBalance: -1, characterRelations: [{ characterId: "lin_ruoning", value: 8 }, { characterId: "chen_xinghe", value: 8 }] },
        evidenceLevel: 6, clarityLevel: 8, riskAwareness: 6, reflectionValue: 8,
        backgroundNote: "你在帮同事改模型的同时，也重新审视了自己的框架。教学是最好的学习。",
      },
      {
        id: "dec-coast",
        label: "年末摸鱼，等明年再说",
        ...
        effects: { researchCredibility: -10, committeeAdoption: -10, portfolioNav: -0.005, viewAccuracy: -6, clientFeedback: -6, teamTrust: -7, fatigue: -10, lifeBalance: 5, characterRelations: [{ characterId: "lin_ruoning", value: -10 }] },
        evidenceLevel: 0, clarityLevel: 0, riskAwareness: 0, reflectionValue: 0,
        backgroundNote: "十二月摸的鱼，会在下一年一月的复盘里变成深深的后悔。",
      },
      {
        id: "dec-party",
        label: "和同事们一起年末聚餐",
